...
public class Demo : MonoBehaviour {
	...
	public void ExplosionGroup(){
		explosionGroupEffect.SetGroupEffect(Effect.ExplosionGroup(),min:0.1f,maxAngle:360).SetGroupModifier(Modifier.CircularOut).SetGroupEffect(Effect.ExplosionGroup(), min: 0.1f, maxAngle: 360)
